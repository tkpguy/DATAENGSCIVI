create table modeling.ivl_dim_mold_tbl(
...
create table modeling.ivl_dim_plant_tbl(
    "country_cd" char(3) not null,
    "plant_cd" varchar(250) not null,
...
create table modeling.ivl_dim_country_tbl(
    "country_cd" char(3) not null,
...
create table modeling.ivl_dim_status_tbl(
...
create table modeling.ivl_dim_unit_tbl(
    "country_cd" char(3) not null,
    "plant_cd" varchar(250) not null,
...
create table modeling.ivl_dim_power_meter_tbl(
    "country_cd" char(3) not null,
    "plant_cd" varchar(250) not null,
